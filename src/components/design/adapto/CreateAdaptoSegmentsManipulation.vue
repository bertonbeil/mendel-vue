            ...
            <el-row :gutter="20" class="mb-30">
              <el-col :span="8">
                <el-form-item label="Study name:" prop="studyName">
                  <el-select
                    v-model="adaptoSegmentsManipulationForm.studyName"
              ...
              <el-col :span="8">
                <el-form-item label="Project name:" prop="projectName">
                  <el-select
                    v-model="adaptoSegmentsManipulationForm.projectName"
                    @change="getRegionList"
                    :disabled="!adaptoSegmentsManipulationForm.studyName"
              ...
              <el-col :span="8">
                <el-form-item label="Assembly name:" prop="assemblyName">
                  <el-select
                    v-model="adaptoSegmentsManipulationForm.assemblyName"
                    :disabled="!adaptoSegmentsManipulationForm.projectName"
              ...
              <el-col :span="8">
                <el-form-item label="Action:" prop="action">
                  <el-select
                    ...
                    :disabled="!adaptoSegmentsManipulationForm.assemblyName"
