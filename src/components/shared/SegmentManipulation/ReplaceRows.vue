<template>
  <el-row :gutter="20" class="mb-30">
    <el-col :span="5">
      <el-select
        v-model="localReplaceRow.segment_type"
        @change="getCustomSegmentList"
    ...
    <el-col :span="5">
      <el-select
        v-model="localReplaceRow.name"
        @change="handleNameChange"
        :disabled="!localReplaceRow.segment_type"
    ...
    <el-col :span="5">
      <el-select
        v-model="localReplaceRow.direction"
        :disabled="!localReplaceRow.segment_type"
...
export default class ReplaceRows extends Vue {
  ...
  localReplaceRow: any = {}
  localCustomSegments: any = []

  getCustomSegmentList (value: any) {
    return httpService.post('query/customSegmentList', { study: this.studyName, project: this.projectName, type: value })
      .then((res: any) => {
        this.localReplaceRow.name = ''
