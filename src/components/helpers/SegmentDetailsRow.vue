<template>
  <el-row class="mb-20 mt-20 rounded bg-gray-200 border-solid border-gray-300">
    ...
    <el-col :span="5" class="mr-10">
      <el-select v-model="localSegmentData.grant" placeholder="Select marker" class="w-full">
        <el-option v-for="grant in grants" :key="grant" :value="grant" :label="grant"></el-option>
      </el-select>
    </el-col>
    <el-col :span="5">
      <el-select v-model="localSegmentData.marker" placeholder="Select marker" class="w-full">
